...
import com.ssafy.happyhouse.model.interceptor.JwtInterceptor;
...
public class HappyhousespringbootApplication implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(jwtInterceptor).addPathPatterns("/user/**") // 기본 적용 경로
				.excludePathPatterns(Arrays.asList("/user/login/**")).excludePathPatterns(Arrays.asList("/user/join"));// 적용 제외 경로
	}
